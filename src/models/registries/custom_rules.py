from models.loss.custom_rules import (
    ExactlyOneShape,
    ExactlyOneMainColour,
    AtMostOneBorderColour,
    BetweenTwoAndThreeNumbers,
    AtMostOneWarning,
    NoSymbolsExactlyTwoColours,
    WarningSignExclusivity,
    WarningImpliesBorderRed,
    WarningImpliesMainWhite,
)
